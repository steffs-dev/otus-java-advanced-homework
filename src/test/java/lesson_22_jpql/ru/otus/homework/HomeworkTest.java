...
class HomeworkTest extends AbstractHibernateHomeworkTest {
...
//    @Disabled("Удалить при выполнении ДЗ")
    @Test
    @DisplayName("testHomeworkRequirementsForTablesCount")
...
//    @Disabled("Удалить при выполнении ДЗ")
    @Test
    @DisplayName("testHomeworkRequirementsForUpdatesCount")
...
//    @Disabled("Удалить при выполнении ДЗ")
    @Test
    @DisplayName("testForHomeworkRequirementsForClientReferences")
...
//    @Disabled("Удалить при выполнении ДЗ")
    @Test
    @DisplayName("testForHomeworkRequirementsForClonedClientReferences")
